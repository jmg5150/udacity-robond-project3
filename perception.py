...
# Exercise-2 TODOs:
    ...
    vox = cloud_no_stat_outliers.make_voxel_grid_filter()
    ...
    # Now doing the same thing for x axis to get rid of corner of bin that is in Field of View
...
def pr2_mover(object_list):
    ...
    print ("Generating %s file" % (yaml_filename))
